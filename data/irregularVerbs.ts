 ...
 */
export const IRREGULAR_VERB_GROUPS: Record<string, { verbs: string[]; past: string[]; pastPart: string[]; emoji: string; rule: string }> = {
  'no change': {
    emoji: '🔄',
    ...
    pastPart: ['let','set','put','cut','hurt','shut','bet','burst','cast','cost','hit','quit','spread','upset','split','thrust','knit','wed','rid'],
  },
  '-aught / -ought': {
    emoji: '🔗',
    ...
    pastPart: ['bought','caught','taught','fought','brought','thought','sought','reached','besought'],
  },
  'i → a → u': {
    emoji: '🔠',
    ...
    pastPart: ['rung','sung','sprung','swum','begun','drunk','sunk','shrunk','stunk','spun','slunk'],
  },
  'i → a (sit → sat)': {
    emoji: '💺',
    ...
    pastPart: ['sat','spat','won','dug','stuck','stung','struck','swung','hung','clung','flung','slunk'],
  },
  '-eep → -ept': {
    emoji: '😴',
    ...
    pastPart: ['kept','slept','swept','wept','crept','leapt'],
  },
  '-end → -ent': {
    emoji: '📨',
    ...
    pastPart: ['sent','spent','lent','bent','built','rent'],
  },
  '-ell → -old': {
    emoji: '💰',
    ...
    pastPart: ['sold','told','spelt','dwelt','smelt'],
  },
  '-ow → -ew → -own': {
    emoji: '💨',
    ...
    pastPart: ['blown','grown','known','thrown','drawn','flown','shown','withdrawn','overflowed'],
  },
  '-ear → -ore': {
    emoji: '👕',
  ...
  '-eel → -elt': {
    ...
    pastPart: ['felt','knelt','dealt','meant','dreamt','leant'],
  },
  '-ind → -ound': {
    emoji: '🔍',
    ...
    pastPart: ['found','ground','wound','bound'],
  },
  'ee → e (meet → met)': {
    emoji: '🤝',
    ...
    pastPart: ['met','fed','sped','bled','bred','led','read','pled'],
  },
  '-eave → -eft': {
    emoji: '🚪',
    rule: 'leave → left',
  ...
  'vowel shift (get → got)': {
    ...
    pastPart: ['gotten','forgotten','chosen','frozen','woken','awakened','broken','stolen','spoken','woven','trodden','whelped'],
  },
  'write → wrote → written': {
    emoji: '✍️',
    ...
    pastPart: ['written','ridden','risen','driven','hidden','bitten','slid','stridden'],
  },
  'double past (come → came)': {
    ...
    pastPart: ['come','become','run','eaten','given','forgiven','taken','mistaken','shaken','seen','fallen','lain','beat'],
  },
  'go / do / have / make': {
    emoji: '⭐',
    ...
    pastPart: ['gone','done','had','made','stood','understood','paid','said','heard','held','sold','told'],
  },
}
...
export const VERB_PRONUNCIATIONS: Record<string, string> = {
  ...
  show:'sho', showed:'shod', shown:'shone',
  ...
  get:'get', got:'got', gotten:'got-en', forget:'for-get', forgot:'for-got', forgotten:'for-got-en',
  choose:'chooz', chose:'choz', chosen:'cho-zen', freeze:'freez', froze:'froz', frozen:'fro-zen',
  wake:'wake', woke:'wok', woken:'wo-ken', awake:'uh-wake', awoke:'uh-wok', awakened:'uh-way-kend',
  break:'brayk', broke:'brok', broken:'bro-ken', steal:'steel', stole:'stol', stolen:'sto-len',
  speak:'speek', spoke:'spok', spoken:'spo-ken', weave:'weev', wove:'wove', woven:'wo-ven',
  tread:'tred', trod:'trod', trodden:'trod-en', whelp:'welp', whelped:'welpt',

  // Group: write -> wrote -> written
  write:'rite', wrote:'rot', written:'rit-en', ride:'ride', rode:'rod', ridden:'rid-en',
  rise:'rize', rose:'roz', risen:'riz-en', drive:'drive', drove:'drov', driven:'driv-en',
  hide:'hide', hid:'hid', hidden:'hid-en', bite:'bite', bit:'bit', bitten:'bit-en',
  slide:'slide', slid:'slid', stride:'stride', strode:'strod', stridden:'strid-en',

  // Group: double past (come -> came)
  come:'kum', came:'kaym', become:'bi-kum', became:'bi-kaym',
  run:'run', ran:'ran', eat:'eet', ate:'ayt', eaten:'ee-ten',
  give:'giv', gave:'gayv', given:'giv-en', forgive:'for-giv', forgave:'for-gayv', forgiven:'for-giv-en',
  take:'tayk', took:'tuk', taken:'tay-ken', mistake:'mis-tayk', mistook:'mis-tuk', mistaken:'mis-tay-ken',
  shake:'shayk', shook:'shuk', shaken:'shay-ken', see:'see', saw:'so', seen:'seen',
  fall:'fol', fell:'fel', fallen:'fol-en', lie:'lie', lay:'lay', lain:'layn',
  beat:'beet',

  // Group: go / do / have / make
  go:'go', went:'went', gone:'gon', do:'doo', did:'did', done:'dun',
