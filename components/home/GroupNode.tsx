...
export default memo(function GroupNode({
  emoji, name, stars, index, left, top, done, unlocked, isCurrent, expanded, onPress,
}: Props) {
    ...
    <Animated.View style={[styles.outer, { left, top }, cascadeStyle]}>
      ...
      >
        ...
        <Animated.View style={[
          ...
          <Text style={[styles.nameText, !unlocked && !done && styles.nameMuted]}
...
const styles = StyleSheet.create({
  ...
  emojiText: { fontSize: 32, lineHeight: 38 },
  nameText: { fontSize: 13, fontWeight: '700', color: '#fff', textAlign: 'center' },
  nameMuted: { color: 'rgba(255,255,255,0.55)' },
