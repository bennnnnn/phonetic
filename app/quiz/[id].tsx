...
export default function QuizScreen() {
  ...
  // Speak feedback each time answered flips to true (new attempt)
  ...
  useEffect(() => {
    ...
    // On wrong, re-speak the word after the encouragement so they can try again
    if (!correct) {
      setTimeout(() => {
        // Only speak if we're still on the same attempt (avoid stale)
  ...
  const handleFinish = () => {
    ...
    router.replace(ROUTES.COMPLETE(id))
  }
