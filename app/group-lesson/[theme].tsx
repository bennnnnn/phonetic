    ...
    <Animated.View style={[styles.focusCard, cardStyle]}>
      ...
      <View style={styles.actionRow}>
        <Animated.View style={[{ flex: 1 }, skipStyle]}>
          <Pressable style={styles.skipBtn} onPress={handleSkipPress} accessibilityRole="button" accessibilityLabel="Skip this word">
            <Text style={styles.skipBtnText}>skip</Text>
          </Pressable>
        </Animated.View>
        <Animated.View style={[{ flex: 1 }, masterStyle]}>
          <Pressable style={styles.masterBtn} onPress={handleMasterPress} accessibilityRole="button" accessibilityLabel="Got it, word mastered">
...
function CompleteBanner({ mastered, skipped, onContinue }: { mastered: number; skipped: number; onContinue: () => void }) {
  ...
  return (
    <Animated.View style={[styles.completeCard, style]}>
      ...
      <TouchableOpacity style={styles.continueBtn} onPress={onContinue} accessibilityRole="button">
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.countBadge}>
          <Text style={styles.countText}>{Math.min(currentIndex + 1, sortedWords.length)}/{sortedWords.length}</Text>
        </View>
      </View>
